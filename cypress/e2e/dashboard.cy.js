...
describe('Login', () => {
  ...
  it('delete a customer', () => {
    ...
    cy.get(Dashboard.page_title).contains(Dashboard.page_title_delete).should('be.visible')
    cy.get(Dashboard.page_subtitle).contains(Dashboard.delete_confirmation_text).should('be.visible')
    cy.get(Dashboard.delete_information).should('be.visible')
    cy.get(Dashboard.confirm_delete_button).click()
  })
})